...
$(document).ready(function(){
    $("#telefone_cel").blur(function(){
        ...
        if(!cel.test($("#telefone_cel").val())){
            if($("#telefone_cel").val() == '' ){
                alert("O telefone celular é obrigatorio, digite um numero valido para prosseguir!");
            }else{
...
$(document).ready(function(){
    $("#telefone_res").blur(function(){
        ...
        if(!res.test($("#telefone_res").val())){
            if($("#telefone_res").val() == '' ){
                alert("O telefone residencial é obrigatorio, digite um numero valido para prosseguir!");
            }else{
                alert("Telefone Inválido, insira um numero valido para prosseguir")
            }
            
        }else{
            $("#telefone_res").prop('disabled', false)
        }
